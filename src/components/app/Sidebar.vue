<template>
  <div class="sidebar" :class="{ open: isOpen }">
    ...
    <div class="sidebar-bottom" v-if="myAcc.role === 'admin'">
      ...
      <router-link to="/lc-vebinar" @click="goToPage('Вебінари')" :class="[isExactActive && 'active']"
                   class="sidebar-center_item sidebar_text">
        <div class="icon_sidebar">
          <svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
            <path
        ...
        <div class="text_sidebar">Вебінари</div>
      </router-link>
      <router-link to="/lc-courses" @click="goToPage('Курси')" :class="[isExactActive && 'active']"
                   class="sidebar-center_item sidebar_text">
        <div class="icon_sidebar">
          <svg class="MuiSvgIcon-root" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
            <path
