      ...
      <div class="popUp">
        <form @submit.prevent="onSubmit">
          <div class="wrap_inputs">
              ...
              />
              <fieldset>
                <legend>Дати проведення курсу (Початок)</legend>
                <input type="date" v-model="singleEvent.start_date" class="profile_input">
              </fieldset>

              <fieldset>
                <legend>Дати проведення курсу (Кінець)</legend>
              ...
              <p class="dropzone_title">Спеціалізації користувачів, які можуть брати участь у курсі</p>
              <div class="wrap_inp">
                <fieldset>
                  <select multiple
    ...
    pickFile2 () {
      ...
      if (file && file[0]) {
        ...
        reader.onload = e => {
          ...
          this.singleEvent.image.append('course_image', this.$refs.fileInput2.files[0])
