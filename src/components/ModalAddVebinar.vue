      ...
      <div class="popUp">
        <form @submit.prevent="onSubmit">
          <div class="wrap_inputs">
              ...
              />
              <fieldset>
                <legend>Дати проведення вебінара (Початок)</legend>
                <input type="datetime-local" v-model="singleEvent.start_date" class="profile_input">
              </fieldset>

              <fieldset>
                <legend>Дати проведення вебінара (Кінець)</legend>
              ...
              <p class="dropzone_title">Зображення для сторінки вебінара</p>
              <div class="d-none">
              ...
              <p class="dropzone_title">Спеціалізації користувачів, які можуть брати участь у вебінарі</p>
              <div class="wrap_inp">
                <fieldset>
                  <select multiple
              ...
              <fieldset>
                <legend>Балів за вебінар</legend>
...
export default {
  ...
  methods: {
    async onSubmit () {
      ...
      if (this.singleEvent.youtube_id !== '') {
        tmp.youtube_id_1 = this.singleEvent.youtube_id
      }
